/*
  Para compilar e executar:
    mpicc -o mpi_trapezio2 mpi_trapezio2.c -lm
    mpirun -n 8 mpi_trapezio2
*/    
...
int main(int argc, char *argv[]) { /* mpi_trapezio.c  */
    ...
    /* printf("Processo %d calculou a integral no intervalo %lf até %lf\n", meu_ranque, local_a, local_b); */
