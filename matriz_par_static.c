/*
    Para compilar e executar:
        gcc -O3 matriz_par_schedule_static.c -o matriz_par_schedule_static -fopenmp
        export OMP_NUM_THREADS=2
        ./matriz_par_schedule_static
*/
...
/* Esse tempo é o resultado do tempo médio de 10 execuções do programa matriz_seq.c também presente nesse 
   diretório.
...
int main() {
    ...
    printf("\n--- Execucao Paralela (Static) com %d Threads ---\n", n_threads);
